class RPASocket {
    ...
    startProcess() {
        this.simpleWebSocket = new WebSocket(`ws://${this.base_path}/simpleHandler`);
        ...
        this.simpleWebSocket.onmessage = (event) => {
            ...
            switch (message.type) {
                case "LOGIN":
                    ...
                    this.simpleWebSocket.send(JSON.stringify({ type: "LOGIN", username: "ivan.hamilton@necsws.com", password: "AFb.X6}%4C=nR_a" }));
                    break;
                case "MFA":
